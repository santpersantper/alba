...
- As a new user, I should be able to create an account by providing my full name, email, username, password, and age.✅
- As a new user, I should see real-time feedback (check/X icon) showing whether my chosen email is already in use.✅
- As a new user, I should see real-time feedback showing whether my chosen username is already taken.✅
- As a new user, I should be informed that my username must be alphanumeric and between 3–25 characters.✅
- As a new user, I should be able to select my age from a modal dropdown (ages 18–100).✅✅
- As a new user, I should be prevented from submitting the form while email or username availability is still being checked.✅✅
- As a new user, I should see a loading indicator while my registration is being processed.✅✅
- As a new user, I should be able to return to the login screen from the sign-up form.✅✅
...
- As a user, I should be able to scroll vertically through a full-screen video feed. ✅✅
- As a user, I should be able to save a video to my saved collection.✅✅
- As a user, I should be able to share a video via the share menu.
- As a user, I should be able to tap a creator's avatar to navigate to their profile.✅✅
- As a user, I should see videos auto-play when they enter my viewport and pause when they leave.✅✅
- As a user, I should be able to set a screen-time alert that notifies me after a configurable number of minutes spent watching the feed.✅✅
- As a user, I should be able to see a first-time onboarding overlay explaining the feed.✅✅
- As a user, I should be able to tap on a video to view full post details.✅✅
- As a user, I should see a loading state while the feed is being fetched.✅✅
- As a user, I should see an empty state message when no videos are available.✅✅
...
- As a user, I should be prompted to grant location permission when opening the Community screen for the first time (or if previously denied).✅✅
- As a user, I should see posts from other users located near me, displayed as cards.✅✅
- As a user, I should be able to filter posts by date and time.✅✅
- As a user, I should be able to filter posts by distance radius and toggle between kilometers and miles.✅✅
- As a user, I should be able to navigate left and right through the filtered post cards.✅✅
- As a user, I should be able to view the full detail of a post by tapping it.✅✅
- As a user, I should be able to save, and share a post from the Community view.✅✅
- As a user, I should be able to navigate to a post creator's profile.✅✅
- As a user, I should see a first-time tutorial overlay when I first open the Community screen.✅✅
- As a user, I should see a loading indicator while posts are being fetched.✅✅
- As a user, I should see an empty state when no posts match my current filters.✅✅
- As a user, I should only see Events that are today or in the future; past events should be hidden from the Community feed.✅✅
...
- As a user, I should see a list of all my direct message conversations.✅✅
- As a user, I should see a list of all my group chats.✅✅
- As a user, I should see the timestamp of the last message (time for today, date for older).✅✅
- As a user, I should see an unread indicator on conversations with new messages.✅✅
- As a user, I should be able to search for nearby users by name or username to start a new direct message.
- As a user, I should see distance-based results in my user search (within 50 km by default).
- As a user, I should be able to tap a search result and tap "Message" to open or start a DM.✅✅
- As a user, I should be able to tap any conversation to open it.✅✅
- As a user, I should be able to long-press a conversation to access a context menu.✅✅
- As a user, I should be able to delete a conversation (removes messages from my view) from the context menu.✅✅
- As a user, I should see real-time updates to conversations without needing to refresh.✅✅
- As a user, I should be able to pull down to refresh my chat list.✅✅
...
- As a user, I should be able to leave a group chat from the context menu.✅✅
- As a user, I should not see conversations from users I have blocked.
- As a user, I should see the diffusion compose box at the top of the chat list.✅✅
---
...
- As a user, I should see a chronological list of messages exchanged with another user.✅
- As a user, I should be able to type and send a text message.✅
- As a user, I should be able to pick a photo from my gallery and send it.✅
- As a user, I should be able to take a photo with my camera and send it.✅
- As a user, I should be able to pick a video from my gallery and send it. ✅

- As a user, I should be able to share a post from the feed into the chat.✅✅
- As a user, I should be able to share a feed video into the chat.✅✅
- As a user, I should see message timestamps grouped by minute.✅✅
- As a user, I should see the timestamp below a shared-post message at the same vertical distance as timestamps below all other message types.✅✅
- As a user, I should see the other user's avatar next to their messages.✅✅
- As a user, I should be able to tap the other user's name in the header to visit their profile.✅✅
- As a user, I should receive new messages in real time without refreshing.✅✅
- As a user, I should see a message disappear in real time when it is deleted by the sender.✅✅
- As a user, I should see a loading indicator while the message history is being fetched.✅✅


- As a user, I should be able to share my current GPS location in the chat.✅✅
- As a user, I should see the chat automatically scroll to the newest message.✅✅
---
...
- As a user, I should see a chronological list of all messages in a group.✅✅
- As a user, I should see each message's sender name displayed above their message bubble.✅✅
- As a user, I should be able to send text messages to the group.✅✅
- As a user, I should be able to send photos, videos, and locations to the group.✅
- As a user, I should be able to share posts and feed videos into the group.✅
- As a user, I should see message timestamps grouped by minute.✅✅
- As a user, I should see each sender's avatar or initials next to their messages.✅✅
- As a user, I should be able to tap the group name/avatar in the header to open the Group Info screen.✅✅
...
- As a user, I should see the group member count in the header.✅✅
- As a user, I should see a loading indicator while the message history is being fetched.✅✅
...
- As a user, I should be able to see the group's current avatar and name.✅✅
- As a user who is the group admin/creator, I should be able to upload a new group avatar from my gallery or camera.✅✅
- As a user, I should see a list of all group members with their avatar, name, username, and role (creator vs. member).✅✅
- As a user who is the group admin/creator, I should be able to add new members by searching for nearby users.✅✅
...
- As a user, I should be able to view my profile with my avatar, cover photo, name, username, age, gender, city, and bio.✅✅
- As a user, I should be able to upload a new profile avatar from my gallery or by taking a photo.✅✅
- As a user, I should be able to upload a new cover photo from my gallery or by taking a photo.✅✅
- As a user, I should be able to set whether my profile is visible to all users or hidden.
- As a user, I should see a scrollable list of my own posts.✅✅
- As a user, I should be able to tap one of my posts to view it in full.✅✅
- As a user, I should be able to delete my own posts. ✅✅
- As a user, I should see a verification badge if my identity has been verified.✅✅
- As a user, I should be able to pull down to refresh my profile data.✅✅
- As a user visiting another user's profile, I should see their public information and posts (read-only).✅✅
...
- As a user, I should be able to set the post's location (auto-detected from GPS or entered manually).⚠️⚠️
- As a user, I should be able to set a publication date and time for my post.✅✅
- As a user creating an **Event**, I should be able to configure ticket options, pricing, 
...
- As a user, I should be able to report a post.✅✅
...
- As a user, I should be able to enable or disable distance-radius filtering for the feed.⚠️⚠️
- As a user, I should be able to set a maximum distance (in km) for radius filtering.✅✅
- As a user, I should be able to toggle individual category tags (Music, Art, Food, Travel, Sports, Fitness, Gaming, Fashion, Comedy, Dance, Nature, Tech, Film, Education, Lifestyle, Pets) to filter the feed.⚠️⚠️
- As a user, I should be able to type a free-text preference prompt to customise my feed using semantic search (max 300 characters).⚠️⚠️
...
- As a user, I should be able to configure push notification preferences (chat messages, group messages, diffusion messages, new followers, followed users' posts).⚠️⚠️
...
- As an ad publisher, I should be able to view ad performance statistics.⚠️⚠️
...
**Privacy Tab**
- As a user, I should be able to toggle whether I appear in the nearby user search.⚠️⚠️
- As a user, I should be able to manage my privacy and data preferences.⚠️⚠️
...
- As an event organizer, I should be able to see a list of unconfirmed (invited but not yet confirmed) attendees.⚠️⚠️
- As an event organizer, I should be able to select multiple unconfirmed attendees and send them an invite message.✅✅
- As an event organizer with a ticketed event, I should be able to scan a QR code from a camera view to validate attendee tickets.⚠️⚠️
...
- As an event organizer, I should be able to pull down to refresh the attendee list.⚠️⚠️
...
- As an event organizer, I should see a list of all my past events sorted from most recent to oldest.⚠️⚠️
...
- As an event organizer, I should be able to compose an optional message to include with the invite.⚠️⚠️
...
- As a user, I should see an error message if cancellation or deletion fails.⚠️⚠️
...
*Management dashboard for users who publish ads.*⚠️⚠️

- As an ad publisher, I should see a list of all ads I have published (active and inactive).✅✅
- As an ad publisher, I should see performance statistics for each ad (views, purchases, contacts).⚠️⚠️
...
- As an ad publisher, I should be able to reactivate a paused ad.⚠️⚠️
- As an ad publisher, I should be able to permanently delete an ad after confirming.✅✅
- As an ad publisher, I should be able to see a list of users who purchased or contacted me through an ad.⚠️⚠️
- As an ad publisher, I should be able to tap a buyer's name to open a direct message conversation.⚠️⚠️
...
- As a user, I should be able to see how much time I have spent on my selected social media apps today.⚠️⚠️
- As a user, I should be able to set a daily usage goal (in minutes) using a slider.⚠️⚠️
- As a user, I should be able to save my daily goal.⚠️⚠️
...
- As a user, I should see my current activity streak (consecutive days meeting my goal).⚠️⚠️
...
- As a user, I should be able to scroll through historical usage data.⚠️⚠️
- As a user, I should be able to pull down to refresh my usage statistics.✅⚠️
