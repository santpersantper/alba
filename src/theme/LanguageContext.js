...
const STRINGS = {
  en: {
    ...
    verification_face_body:
      "We’ll take a quick selfie and compare it with your profile picture to confirm that it’s really you. Make sure your face is clearly visible and well lit.",
    ...
    face_no_face_detected: "No face detected. Please take a photo where your face is clearly visible.",
    ...
    signup_button_label: 'Proceed',
    signup_complete_label: 'Sign Up',
    signup_code_sent_prefix: 'A verification code has been sent to',
    signup_code_placeholder: '000000',
    signup_code_resend: 'Resend code',
    signup_code_sending: 'Sending…',
    signup_code_edit_details: 'Edit details',
    signup_code_invalid_title: 'Invalid code',
    signup_code_invalid_body: 'The code you entered is incorrect. Please try again.',
    signup_code_expired_body: 'This code has expired. Please request a new one.',
    signup_code_enter_6_digits: 'Please enter the full 6-digit code.',
    signup_code_ratelimit_title: 'Please wait',
    signup_code_ratelimit_body: 'A code was recently sent. Please wait',
    signup_code_resent_title: 'Code sent',
    signup_code_resent_body: 'A new verification code has been sent to your email.',
    signup_device_banned_title: 'Account not available',
    signup_device_banned_body: 'An account from this device has been disabled due to a violation of our Terms of Service. New accounts cannot be created from this device.',
    signup_device_limit_title: 'Device limit reached',
    signup_device_limit_body: 'The maximum number of accounts for this device has been reached.',
    signup_ip_limit_title: 'Account limit reached',
    signup_ip_limit_body: 'The maximum number of accounts from this network has been reached.',
    signup_disposable_email_title: 'Email not accepted',
    signup_disposable_email_body: 'Please use a permanent email address to create an account. Temporary or disposable email services are not accepted.',

    login_new_device_title: 'New device detected',
    login_new_device_body: 'For your security, enter the verification code sent to',
    login_new_device_verify_btn: 'Verify',
    login_device_ratelimit_title: 'Please wait',
    login_device_ratelimit_body: 'A code was recently sent. Please wait',
    ...
    profile_dm_blocked_title: "Can't send message",
    profile_dm_blocked_body: "This user doesn't accept messages from people they don't know yet.",
    profile_ok: "OK",
    ...
    premium_ad_free_sub: "Browse Community without ads — €5.00/month subscription",
    premium_traveler_label: "Traveler Mode",
    premium_traveler_sub: "Access Community in any city worldwide — €5.00/week subscription",
    ...
    notif_screentime_time_label: "Screen time daily reminder",
    notif_screentime_time_sub: "Time for daily goal & weekly report notifications.",
    ...
    usetime_no_apps_title: "No apps selected",
    usetime_no_apps_body: "Select the social media apps you want to track to start monitoring your screen time.",
    usetime_select_apps: "Select apps",
    ...
    usetime_last_updated: "Last updated at {time}",
    usetime_pull_to_refresh: "Pull down to refresh.",
    ...
    usetime_day_singular: "day streak",
    usetime_day_plural: "days streak",
    usetime_no_streak: "Start your streak today",
    usetime_tracked_today: "Time on tracked apps today",
    usetime_tracked_week: "Time on tracked apps this week",
    usetime_streak_days: "You've been keeping your streak for {n} days",
    usetime_pct_goal: "{pct}% of daily goal",
    ...
    group_see_requests: "See requests to join",
    group_no_requests: "No pending requests.",
    group_approve: "Approve",
    group_decline: "Decline",
    group_remove_admin: "Remove admin",
    change_end_date_time: "End date and time",
    event_purchases_active: "Allow ticket purchases",
    event_purchases_active_sub: "Users can buy tickets for this event",

    group_review_messages: "Review messages",
    group_no_pending_messages: "No messages to review.",
    group_read_more: "Read more",
    group_read_less: "Read less",
    group_link_review_title: "Message Under Review",
    group_link_review_body: "Your message contains a link. Admins will review it before it becomes visible to other members.",
    group_link_review_ok: "OK",

    /* ---------- Community – location denied ---------- */
    community_location_denied_caption: "We can only show you events near you if we know where you are.",
  ...
  it: {
    ...
    verification_face_body:
      "Scatteremo un selfie e lo confronteremo con la tua foto profilo per confermare che sei davvero tu. Assicurati che il tuo viso sia ben visibile e illuminato.",
    ...
    face_no_face_detected: "Nessun volto rilevato. Scatta una foto in cui il tuo viso sia chiaramente visibile.",
    ...
    signup_button_label: 'Procedi',
    signup_complete_label: 'Iscriviti',
    signup_code_sent_prefix: 'Un codice di verifica è stato inviato a',
    signup_code_placeholder: '000000',
    signup_code_resend: 'Invia di nuovo il codice',
    signup_code_sending: 'Invio in corso…',
    signup_code_edit_details: 'Modifica i dati',
    signup_code_invalid_title: 'Codice non valido',
    signup_code_invalid_body: 'Il codice inserito non è corretto. Riprova.',
    signup_code_expired_body: 'Questo codice è scaduto. Richiedine uno nuovo.',
    signup_code_enter_6_digits: 'Inserisci il codice completo a 6 cifre.',
    signup_code_ratelimit_title: 'Attendi',
    signup_code_ratelimit_body: 'Un codice è stato inviato di recente. Attendi',
    signup_code_resent_title: 'Codice inviato',
    signup_code_resent_body: 'Un nuovo codice di verifica è stato inviato alla tua email.',
    signup_device_banned_title: 'Account non disponibile',
    signup_device_banned_body: 'Un account da questo dispositivo è stato disabilitato per violazione dei Termini di Servizio. Non è possibile creare nuovi account da questo dispositivo.',
    signup_device_limit_title: 'Limite dispositivo raggiunto',
    signup_device_limit_body: 'È stato raggiunto il numero massimo di account per questo dispositivo.',
    signup_ip_limit_title: 'Limite account raggiunto',
    signup_ip_limit_body: 'È stato raggiunto il numero massimo di account da questa rete.',
    signup_disposable_email_title: 'Email non accettata',
    signup_disposable_email_body: 'Per creare un account utilizza un indirizzo email permanente. I servizi email temporanei o usa e getta non sono accettati.',

    login_new_device_title: 'Nuovo dispositivo rilevato',
    login_new_device_body: 'Per la tua sicurezza, inserisci il codice di verifica inviato a',
    login_new_device_verify_btn: 'Verifica',
    login_device_ratelimit_title: 'Attendi',
    login_device_ratelimit_body: 'Un codice è stato inviato di recente. Attendi',
    ...
    profile_dm_blocked_title: "Impossibile inviare messaggio",
    profile_dm_blocked_body: "Questo utente non accetta messaggi da persone che non conosce ancora.",
    profile_ok: "OK",
    ...
    premium_ad_free_sub: "Naviga la Community senza pubblicità — €5,00/mese (abbonamento)",
    premium_traveler_label: "Modalità Viaggiatore",
    premium_traveler_sub: "Accedi alla Community in qualsiasi città — €5,00/settimana (abbonamento)",
    ...
    notif_screentime_time_label: "Promemoria giornaliero screen time",
    notif_screentime_time_sub: "Orario per le notifiche di obiettivo giornaliero e report settimanale.",
    ...
    usetime_no_apps_title: "Nessuna app selezionata",
    usetime_no_apps_body: "Seleziona le app social che vuoi monitorare per iniziare a tracciare il tempo schermo.",
    usetime_select_apps: "Seleziona app",
    ...
    usetime_last_updated: "Ultimo aggiornamento alle {time}",
    usetime_pull_to_refresh: "Scorri verso il basso per aggiornare.",
    ...
    usetime_day_singular: "giorno di streak",
    usetime_day_plural: "giorni di streak",
    usetime_no_streak: "Inizia la tua streak oggi",
    usetime_tracked_today: "Tempo sulle app tracciate oggi",
    usetime_tracked_week: "Tempo sulle app tracciate questa settimana",
    usetime_streak_days: "Stai mantenendo la streak da {n} giorni",
    usetime_pct_goal: "{pct}% dell'obiettivo giornaliero",
    ...
    group_see_requests: "Vedi richieste di accesso",
    group_no_requests: "Nessuna richiesta in attesa.",
    group_approve: "Approva",
    group_decline: "Rifiuta",
    group_remove_admin: "Rimuovi admin",
    change_end_date_time: "Data e ora di fine",
    event_purchases_active: "Consenti acquisto biglietti",
    event_purchases_active_sub: "Gli utenti possono acquistare biglietti per questo evento",

    group_review_messages: "Esamina messaggi",
    group_no_pending_messages: "Nessun messaggio da esaminare.",
    group_read_more: "Leggi di più",
    group_read_less: "Leggi meno",
    group_link_review_title: "Messaggio in Revisione",
    group_link_review_body: "Il tuo messaggio contiene un link. Gli admin lo esamineranno prima che diventi visibile agli altri membri.",
    group_link_review_ok: "OK",

    /* ---------- Community – location denied ---------- */
    community_location_denied_caption: "Possiamo mostrarti solo gli eventi vicino a te se sappiamo dove ti trovi.",
